...
from .multi_loader_core import (
    MAX_FILES, OUTPUT_SLOT_OPTIONS, OUTPUT_SLOTS_TOOLTIP, parse_files, resample_frame_indices,
)
...
class ITLMultiVideoLoader(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            ...
            description=f"Drop up to {MAX_FILES} video files onto the node; each gets its own video_N and "
